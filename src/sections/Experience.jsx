...
const experiences = [
  ...
  description:
    "Built and deployed full-stack web applications using React, Next.js, and MERN, with real-world API integrations and cloud deployment."
},
  ...
  duration: "2025 - Present",
  description:
    "Explored cloud fundamentals, deployment pipelines, Docker, and version control while continuously building projects and experimenting with scalable application architecture."
}
,
{
  role: "Hackathon Participant",
  company: "Tutedude Hackathon",
  duration: "2025",
  description:
    "Collaborated in a team environment to build a MERN-stack e-commerce platform, contributing to frontend development and API integration under time constraints."
}
,
