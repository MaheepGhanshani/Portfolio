...
const testimonials = [
  {
    name: "Ayush Singh",
    role: "Full stack developer at Magnet Brains",
    review:
      "Maheep is a visionary developer. His attention to detail and creativity blew us away. Our project was a massive success because of him.",
    image: m1, // Points to imported image
  },
  {
    name: "Aman Pratap Forster",
    role: "Student at Vellore institute of technology",
    review:
      "Working with Maheep was an absolute pleasure. He brings design and code together like magic. Highly admire him!",
    image: w1,
  },
  {
    name: "Arnish Baruah",
    role: "Frontend intern at IIT KGP",
    review:
      "From concept to execution, Maheep handled everything flawlessly. His work ethic and innovation are unmatched.",
    image: m2,
  },
  {
    name: "Priyanshu Singh Tomar",
    role: "Student at Vellore institute of technology",
    review:
      "Maheep transformed our outdated project idea into something modern and powerful. His skills are world-class.",
    image: w2,
  },
];
