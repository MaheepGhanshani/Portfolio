...
export default function Projects() {
  ...
  const projects = React.useMemo(
    () => [
      {
        title: "QuickBasket",
        link: "https://quickbasket-1-097t.onrender.com/",
        bgColor: "#0d4d3d",
        image: isMobile ? photo1 : img1, // Mobile vs desktop image
      },
      {
        title: "Fitness Coach AI",
        link: "https://ai-fitness-ez0v.onrender.com/",
        bgColor: "#1C1F26",
        image: isMobile ? p2 : img2,
      },
      {
        title: "Connect4",
        link: "https://connect4-1-hfp9.onrender.com/",
        bgColor: "#dc9317",
        image: isMobile ? c4 : connect4,
      },
      {
        title: "Taskio",
        link: "https://taskio-1.onrender.com/",
        bgColor: "#FFD54F",
        image: isMobile ? t2 : t1,
      },
      {
        title: "BrainScope",
        link: "https://github.com/rajnishsingh777/Brain-tumor-detection",
        bgColor: "#050A0F",
        image: isMobile ? bt1 : bt2,
      },
    ],
    [isMobile] 
