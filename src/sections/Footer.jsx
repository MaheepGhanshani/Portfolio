...
const socials = [
  ...
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/maheep-ghanshani-28393a251/" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/im_maheep/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/MaheepGhanshani" },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Maheep Ghannshani. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
