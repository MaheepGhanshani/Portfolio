        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I build modern, scalable web applications with a strong focus on clean code, responsive design, and performance. My toolkit includes React, Next.js, JavaScript, Tailwind CSS, Node.js, and MongoDB, allowing me to take ideas from concept to deployment. I enjoy working with APIs and emerging technologies like AI and cloud platforms, having integrated services such as OpenAI, Gemini, Stripe, and Firebase into real-world projects. With hands-on experience in full-stack development and cloud tools like AWS and Oracle Cloud, I aim to create reliable, user-friendly solutions that make a meaningful impact.
            </p>
...
{ label: "Tech Stack", value: "MERN, React, Next.js" },
{ label: "Specialization", value: " Cyer Security " },
{ label: "Certifications", value: "AWS solutions architect associate" }
              ].map((item, i) => (
                <motion.div
                  key={i}
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I’m a Web Developer and Software Developer with a strong interest in building modern, reliable applications and exploring new technologies.</p>
            <p className="mt-4 text-gray-400 text-base sm:text-lg">
             I enjoy turning ideas into clean, user-friendly solutions and sharing my learning journey with the developer community.
            </p>
          </motion.div>
        </div>
      </div>
